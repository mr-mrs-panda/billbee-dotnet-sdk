...
namespace Panda.NuGet.BillbeeClient.Endpoints.Interfaces
{
    ...
    public interface IOrderEndPoint
    {
        ...
        Task<ApiResult<List<string>>> GetPatchableFieldsAsync();
        ...
        /// <returns></returns>
        Task<ApiResult<Order>> PatchOrderAsync(long id, Dictionary<string, object> fieldsToPatch);
        ...
        /// <returns>Details of the order</returns>
        Task<ApiResult<Order>> GetOrderByExternalReferenceAsync(string id);
        ...
        /// <returns></returns>
        Task<ApiPagedResult<List<Order>>> GetOrderListAsync(DateTime? minOrderDate = null,
        ...
        /// <param name="excludeTags">Defines, that no tags should be supplied</param>
        /// <returns></returns>
        Task<ApiResult<List<InvoiceDetail>>> GetInvoiceListAsync(
        ...
        /// <param name="order">An order object, to create in billbee</param>
        /// <returns></returns>
        Task<ApiResult<Order>> PostNewOrderAsync(Order order);
        ...
        Task AddTagsAsync(List<string> tags, long orderId);
        ...
        /// <param name="orderId">Id of the order, where the tags should be edited.</param>
        /// <returns>ApiResult with the result of the update operation</returns>
        Task UpdateTagsAsync(List<string> tags, long orderId);
        ...
        Task<ApiResult<DeliveryNote>> CreateDeliveryNoteAsync(long orderId, bool includePdf = false, long? sendToCloudId = null);
        ...
        Task<ApiResult<Invoice>> CreateInvoiceAsync(long orderId, bool includePdf = false, long? templateId = null, long? sendToCloudId = null);
        ...
        Task ChangeOrderStateAsync(long id, OrderStateEnum state);
        ...
        Task SendMailForOrderAsync(long orderId, SendMessage message);
        ...
        Task<ApiResult<List<LayoutTemplate>>> GetLayoutsAsync();
